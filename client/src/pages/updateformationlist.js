  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (originalForm.date !== form.date) {
        ...
        let message = `Il y a une modification dans la formation de l'offre ${nomOffre} La nouvelle date est : ${form.date}`;
      ...
      if (originalForm.type !== form.type) {
        ...
        let message = `Il y a une modification dans l'formation de l'offre ${nomOffre} Votre formation est devenu ${form.type}.`;
